...
public class ServerArrivalLoungeCom {
    ...
    public ServerArrivalLoungeCom (int portNumb)
    {
    ...
    public ServerArrivalLoungeCom (int portNumb, ServerSocket lSocket) {
        serverPortNumb = portNumb;
    ...
    public ServerArrivalLoungeCom accept () throws SocketTimeoutException {
        ServerArrivalLoungeCom scon;                                      // canal de comunicação

        scon = new ServerArrivalLoungeCom(serverPortNumb, listeningSocket);
        try {
