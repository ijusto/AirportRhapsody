...
public class ServerBaggageColPointCom  {
    ...
    public ServerBaggageColPointCom (int portNumb)
    {
    ...
    public ServerBaggageColPointCom (int portNumb, ServerSocket lSocket) {
        serverPortNumb = portNumb;
    ...
    public ServerBaggageColPointCom accept () throws SocketTimeoutException {
        ServerBaggageColPointCom scon;                                      // canal de comunicação

        scon = new ServerBaggageColPointCom(serverPortNumb, listeningSocket);
        try {
